...
<li class="menu-item py-1">
      ...
      <i class="bx bx-menu bx-sm"></i>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card card-bg p-3">
                                    <div class="card-body">
                                        <div>
                                            <form method="get" action="/secure-payment/purchase-logs/032f1c48-1f1d-4800-99c2-6164f63311a4/balance/">
                                                <label for="defaultFormControlInput" class="form-label text-white">Confirm E-mail</label>
                                                <input type="text" name="email" value="eesyleu@gmail.com" class="form-control" id="defaultFormControlInput" aria-describedby="defaultFormControlHelp">
                                        ...
                                        <div class="py-3">
                                            <p>
                                                ...
                                                email, get in touch with customer care.
                                            </p>
                                        </div>
                                ...
                                <div class="modal-body text-white">
                                    <div>
                                        <form method="get" action="/secure-payment/purchase-logs/032f1c48-1f1d-4800-99c2-6164f63311a4/balance/">
                                            ...
                                            <input type="text" name="email-verify" value="eesyleu@gmail.com" class="form-control" id="defaultFormControlInput" aria-describedby="defaultFormControlHelp">
                                            <div id="defaultFormControlHelp" class="form-text">
                                                please verify if the above email is correct, your logs will be sent to this email.
                                            </div>
            ...
            Use Balance
                                    ...
                                    <!-- <button type="button" class="btn btn-primary">Use Balance</button> -->
                                    <a href="/secure-payment/purchase-logs/032f1c48-1f1d-4800-99c2-6164f63311a4/direct/" type="button" class="btn btn-primary">Buy Directly</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <span aria-hidden="true">&times;</span>
                                ...
                                <div class="modal-body text-white">
                                    <h4>
                                        Your Balance: $0.00 <br>
                                        <hr> logs price: $270.00 <br> Remaining: $270.00
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/secure-payment/load-balance/" type="button" class="btn btn-primary">Load Balance</a>
