<?php
 ...
 if($balance>0){
    $sql = "SELECT id, balance, info, price FROM boe where price > $balance";
    ...
    $sql = "SELECT id, balance, info, price FROM boe";
$result = $conn->query($sql);
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">UK-Banks > Bank of England</a></li>
                    </ol>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="buy.php">
                                ...
                                <input type="hidden" name="bank" value="Bank of England">
