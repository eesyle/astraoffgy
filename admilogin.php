...
$password = get_post($conn, 'password');
 ...
 if($password=="123456789" && $username=="obedofla"){
    $_SESSION["id"] =$row["id"];
    header('location:AdminsDash.php');
 }
 else{
...
<head>
   ...
   <link rel="stylesheet" href="static\css\de.css" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      ...
      <i class="bx bx-menu bx-sm"></i>
                ...
                UserName<span class="asteriskField">*</span> </label> <input type="text" id ="username" name="username" placeholder="Username" autocomplete="email" class="textinput form-control" required id="id_login"> </div>
                                            <div id="div_id_password" class="mb-3">
                                            <label for="id_password" class="form-label requiredField">
                Password<span class="asteriskField">*</span> </label> <input type="password" name="password" placeholder="Password" autocomplete="current-password" class="passwordinput form-control" required id="id_password"> </div>
