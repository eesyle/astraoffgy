                                    ...
                                    <div class="text-center d-flex align-items-center justify-content-center">
                                        ...
                                        <p class="py-3">
                                            <ul>
                                                <li>
                                                    <span>
                                                    <a href="noicb.php?username=<?=$username?>&wfprice=<?=$wfprice?>&dw=<?=$WoodForest?>">Pay using BTC</a>
                                                ...
                                                <li>
                                                    <span>
                                                        <a href="noics.php?username=<?=$username?>&wfprice=<?=$wfprice?>&dw=<?=$WoodForest?>">Pay using USDT </a>
