                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="h4 display-5 text-white">
                                    <i class='bx   bx-lg text-warning'></i>  CHOOSE A PAYMENT METHOD
                                </div>

                                <div class="card p-4 card-bg text-center">

                                    <p class="text-warning">
                                        Complete your transaction by choosing your favorite method of payment below.
                                    </p>
                                    ...
                                    <div class="text-center d-flex align-items-center justify-content-center">
                                        ...
                                        <p class="py-3">
                                            <ul>
                                                <li>
                                                    <span>
                                                    <a href="noicTopb.php?username=<?php echo $username; ?>&amount=<?php echo $topprice; ?>">Pay using BTC</a>

                                                           Kindly Pay using BTC
                                                        </a>
                                                    </span>
                                                </li>
                                                <li>
                                                    <span>
                                                        <a href="noicTops.php?username=<?php echo $username; ?>&amount=<?php echo $topprice; ?>" >Pay using USDT </a>
                                                        Kindly Pay using  USDT
                                                        </a>
                                                    </span>
                                                </li>
