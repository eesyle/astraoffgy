...
<head>
  ...
  <title>RBC BANK Details</title>
   <!-- Required meta tags -->
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.11.0/css/jquery.dataTables.css"></div>
...
<div class="container mt-4">
  <h3 class="mb-4">RBC BANK Details</h3>
      ...
      <div class="tab-content border-start border-end border-bottom p-3" id="infoTabContent">
        <div class="tab-pane fade show active" id="info-text" role="tabpanel">
          <form method="POST" action="code.php">
            ...
            <input type="hidden" name="table" value="rbc">
            <input type="hidden" name="redirect_path" value="rbc_index.php">
            <div class="mb-3">
  ...
  <!-- Data Table -->
  <div class="card">
    <div class="card-header">RBC Records</div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
              include 'dbcon.php';
              $query = "SELECT * FROM rbc ORDER BY id DESC";
            ...
            ?>
              <tr>
                ...
                <td>
                  <?php if (file_exists('rbc_edit.php')): ?>
                    <a href="rbc_edit.php?id=<?= urlencode($user['id']) ?>" class="btn btn-sm btn-info">Edit</a>
                  <?php endif; ?>
                  <?php if (file_exists('code_rbc.php')): ?>
                    <form action="code_rbc.php" method="POST" style="display:inline-block">
