            ...
            <div class="col-md-12  ">
                <div class="card">
                    ...
                    <div class="table-responsive text-noswrap pt-1 " >
                        <table class="table table-bordered table-responsive table-striped" id="rbc">
                            <thead>
                                <tr >
                                    <th>ID</th>
                                    <th>Balance</th>
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT id, balance, info, price FROM rbc";
                                    ...
                                    if($query_run && mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td><?= $student['price']; ?></td>
                                                <td>
                                                    <a href="rbc_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code_rbc.php" method="POST" class="d-inline">
