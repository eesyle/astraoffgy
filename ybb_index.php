...
<head>
    ...
    <title>EDITING BARCLAYS BANK</title>
                ...
                <div class="card">
                    ...
                    <div class="p-3">
                      <form action="code.php" method="POST" class="card card-body mb-3">
                        <input type="hidden" name="table" value="barcly" />
                        <input type="hidden" name="redirect_path" value="ybb_index.php" />
                        <div class="row">
                          ...
                          <div class="col-md-4 mb-2 form-check">
                            <input type="checkbox" name="recalc_price_only" class="form-check-input" id="barcly_recalc_only">
                            <label class="form-check-label" for="barcly_recalc_only">Only recalc prices (keep balances)</label>
                          </div>
                        </div>
                        <div>
                      ...
                      <form action="code.php" method="POST" class="card card-body mb-3">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 mb-2 form-check">
                            <input type="checkbox" name="apply_by_parts" class="form-check-input" id="barcly_info_parts_chk">
                            <label class="form-check-label" for="barcly_info_parts_chk">Compose from parts</label>
                          </div>
                          <div class="col-md-12">
                            <div class="row">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td><?= $student['price']; ?></td>
                                                <td>
                                                    <a href="ybb_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code_ybb.php" method="POST" class="d-inline">
