...
<head>
    ...
    .navbar-custom {
            background-color: #0d0b2e !important;
            box-shadow: none !important;
        }

        .h4-display {
            margin-top: 20px; /* Adjust the initial margin-top as needed */
        }

        @media (max-width: 767px) {
            /* Adjust margin-top for small screens */
            .h4-display {
                margin-top: -37px; /* Increase the margin-top for small screens */
            }
        }
  </style>
...
<body>
    ...
    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/aust.png">
 
      <h3 style="color: #000;  ">AUSTRALIA BANK LOGS</h3>
     <a href="aria.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/CAN.png">
 
      <h3 style="color: #000;  ">CANADA BANK LOGS</h3>
     <a href="wato.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/UK.png">
 
      <h3 style="color: #000;  ">UK BANK LOGS</h3>
     <a href="shis.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/ly.png">
