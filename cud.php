<?php
 ...
 if($balance>0){
    $sql = "SELECT id, balance, info, price FROM dcu where price > $balance";
    ...
    $sql = "SELECT id, balance, info, price FROM dcu";
$result = $conn->query($sql);
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">US-Banks > DCU</a></li>
                    </ol>
                </div>
