...
<body>
    ...
    <img src="banklogs/nab.png ">
     <a href="nab.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/anz.png ">
     <a href="zam.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/suncorp2.png ">
     <a href="amp.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>
