            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit An Account 
                            <a href="charlesschwab_index.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM charlesschwab WHERE id='$student_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="code_charlesschwab.php" method="POST">
