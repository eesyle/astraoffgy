                        ...
                        <div class="card mb-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" id="bulkInfoForm">
                                    ...
                                    <input type="hidden" name="table" value="sbi">
                                    <input type="hidden" name="redirect_path" value="sbi_index.php">
...
<small class="text-muted">Minimum Price anchors the curve; prices spread up to the cap (exclusive).</small>
                    ...
                    <div class="table-responsive text-noswrap pt-1 " >
                        <table class="table table-bordered table-responsive table-striped" id="sbi">
                            <thead>
                                <tr >
                                    <th>ID</th>
                                    <th>Balance</th>
                                            ...
                                            <tr  >
                                                ...
                                                <td>
                                                    <?php if(isset($_SESSION['auth_user'])): ?>
                                                        <a href="sbi_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                        <form action="code_sbi.php" method="POST" class="d-inline">
