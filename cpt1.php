                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 align-items-right ">
                                    <a href="Dashboad.php?username=<?=$username?>" class="align-items-right">Dashabord</a> / CAPITAL ONE Bank
                                </div>
                            </div>

                            <div class="row py-2">
                                <div class="bg-dark2 text-white">
                                    <h5 class="card-header text-white"> CAPITAL ONE Bank</h5>
                                </div>
...
$query = "SELECT * FROM cpt1  ORDER BY RAND()";
...
if (mysqli_num_rows($query_run) > 0) {
    ...
    foreach ($query_run as $bank) {
        ...
        $link = ($label === "Sold") ? "javascript:void(0);" : "paymentMethod.php";
        ?>
        <tr>
            ...
            <td>
            <form method="post" action="CnfirmEmailToBuycpt1.php?username=<?=$username?>">
