...
if(isset($_POST['delete_student']))
{
    ...
    $query = "DELETE FROM paypal WHERE id='$student_id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Account Deleted Successfully";
        header("Location: ly_index.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update_student']))
{
    ...
    $price = mysqli_real_escape_string($con, $_POST['price']);
        ...
        $query = "UPDATE paypal SET  id = '$id', Balance='$balance', Title='$title', info='$info', price='$price' WHERE id='$student_id' ";
    $query_run = mysqli_query($con, $query);
