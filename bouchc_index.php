                        ...
                        <div class="card mb-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" id="bulkInfoForm">
                                    ...
                                    <input type="hidden" name="table" value="hsbc">
                                    <input type="hidden" name="redirect_path" value="bouchc_index.php">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td><?= $student['price']; ?></td>
                                                <td>
                                                    <a href="bouchc_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code_bouchc.php" method="POST" class="d-inline">
