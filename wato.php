...
<body>
    ...
    <img src="banklogs/hsbc.png ">
     <a href="bouchc.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/td2.png ">
     <a href="atew.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>

    <div class="custom-card "  style="background-color: #fff;">
    <img src="banklogs/cibc.png">
     <a href="chris.php?username=<?= $username ?>">VIEW LOGS</a> 
    </div>
