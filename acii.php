<?php
 ...
 if($balance>0){
    $sql = "SELECT id, balance, info, price FROM citi where price > $balance";
    ...
    $sql = "SELECT id, balance, info, price FROM citi";
$result = $conn->query($sql);
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">US-Banks > CITI</a></li>
                    </ol>
                </div>
