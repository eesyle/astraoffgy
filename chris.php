                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 align-items-right ">
                                    <a href="Dashboad.php?username=<?=$username?>" class="align-items-right">Dashabord</a> /CIBC
                                </div>
                            </div>

                            <div class="row py-2">
                                <div class="bg-dark2 text-white">
                                    <h5 class="card-header text-white"> CIBC</h5>
                                </div>
...
$query = "SELECT  * FROM cibc  ORDER BY RAND()";
