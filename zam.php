                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 align-items-right ">
                                    <a href="Dashboad.php?username=<?=$username?>" class="align-items-right">Dashabord</a> / ANZ Bank
                                </div>
                            </div>

                            <div class="row py-2">
                                <div class="bg-dark2 text-white">
                                    <h5 class="card-header text-white"> ANZ Bank</h5>
                                </div>
...
$query = "SELECT  * FROM anz ORDER BY RAND()";
...
if (mysqli_num_rows($query_run) > 0) {
    foreach ($query_run as $bank) {
        ...
        $link = ($label === "Sold") ? "javascript:void(0);" : "shyb.php?username=<?=$username?>";
        ?>
        <tr>
            ...
            <td>
            <form method="post" action="CnfirmEmailToBuyanz.php?username=<?=$username?>">
