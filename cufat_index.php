                ...
                <div class="card">
                    ...
                    <div class="px-3 pt-3">
                        <div class="card mb-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="code_cufat.php" method="POST" id="bulkInfoForm">
                    ...
                    <div class="px-3">
                        <div class="card mb-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="code_cufat.php" method="POST" id="bulkBalancePriceForm">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td><?= $student['price']; ?></td>
                                                <td>
                                                    <a href="cufat-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code_cufat.php" method="POST" class="d-inline">
