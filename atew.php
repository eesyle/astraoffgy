                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 align-items-right ">
                                    <a href="Dashboad.php?username=<?=$username?>" class="align-items-right">Dashabord</a> / TD Canada
                                </div>
                            </div>

                            <div class="row py-2">
                                <div class="bg-dark2 text-white">
                                    <h5 class="card-header text-white"> TD Canada</h5>
                                </div>
...
$query = "SELECT  * FROM t_d  ORDER BY RAND()";
...
if (mysqli_num_rows($query_run) > 0) {
    foreach ($query_run as $bank) {
        ...
        <tr>
            ...
            <form method="post" action="CnfirmEmailToBuyTD.php?username=<?=$username?>">
