...
<head>
    ...
    <meta property="og:title" content="Astradox Pro — CANADA BANKLOGS">
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">CANADA BANKLOGS > TD Canada Bank</a></li>
                    </ol>
                </div>
                ...
                <?php foreach ($rows as $row): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <h2><sup>C$</sup> <strong class="text-white"><?php echo number_format($row['balance'], 2); ?></strong></h2>
                        </td>
                        <td class="whitesp-no">
                            <ul>
                                <?php 
