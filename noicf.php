...
if (!isset($_SESSION['username']) || !isset($_SESSION['wfprice']) || !isset($_SESSION['WoodForest'])) {
    echo "session is empty";
    
}

$username = $_SESSION['username'];
$wfprice = $_SESSION['wfprice'];
$WoodForest = $_SESSION['dw'];
...
$emailAddresses = [
    EMAIL_ADDRESS_1 => "<p>Offgy Logsstoree <br> Your purchase  $generatedCode-$thbank ORDER

    </p>
        <p>Dear $username  Your purchase with reference $generatedCode of a price: $ $theprice
        Has been processed succefully. your transaction is pending you will be notified on how to provide relevant credentials for your order to be processed when the payment is received
        </p>
        <p>Thank you for using offgy Logsstore</p>",
...
require $_SERVER['DOCUMENT_ROOT'] . '/mail/SMTP.php';
    ...
    try {
        ...
        <p>User $username  Has just purchased a license $$theprice in $thbank Bank</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="h4 display-5 text-white">
                                    <i class='bx bxl-bitcoin bx-lg text-warning'></i> bitcoin Payment
                                </div>

                                <div class="card p-4 card-bg text-center">

                                   <p class="text-warning">
    Complete your transaction by paying using  BTC to the address below.
</p>



                                    <div class="text-center d-flex align-items-center justify-content-center">
                                        <p class="p-2 bg-main-light">1A27g5qNxaFtw3oe4yvuqqPRohD3U4CUFY</p>
                                        <div></div>
                                        <input type="text" id="myInput" value="1A27g5qNxaFtw3oe4yvuqqPRohD3U4CUFY" hidden>
                        ...
                        <i class='bx bxs-copy bx-md'></i>
                                    ...
                                    <div>
                                        <img src="btcoin.jpg" alt="" srcset="" style="width: 200px;">
                                    </div>
                                    <div class="mt-3">
