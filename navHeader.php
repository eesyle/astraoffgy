<div class="nav-header" style="background: linear-gradient(180deg, #0f0f10, #1a1a1e); color: #e6e6e9; border-bottom: 1px solid #2b2b30;">
            <a href="./" class="brand-logo">
                <div class="logo">
                    <img class="logo-abbr" src="assets/logo.png" style="width: 50px; height: 45px;"></img>
                    <h1 class="brand-title font-w600 text-white" style="color:#ffffff;">HoldLogix</h1>
                </div>
