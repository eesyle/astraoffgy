<?php
 ...
 if($balance>0){
    $sql = "SELECT id, balance, info, price FROM schroders where price > $balance";
    ...
    $sql = "SELECT id, balance, info, price FROM schroders";
$result = $conn->query($sql);
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">UK-Banks > Schroders</a></li>
                    </ol>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="buy.php">
                                ...
                                <input type="hidden" name="bank" value="Schroders">
