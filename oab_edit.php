            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4> Editting Bank OF America 
                            <a href="oab_index.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM bankofamerica WHERE id='$student_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="code_oab.php" method="POST">
