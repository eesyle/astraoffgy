...
<head>
    ...
    <title>EDITING BANK OF AMERICA BANK</title>
                ...
                <div class="card">
                    ...
                    <div class="p-3">
                      <form action="code.php" method="POST" class="card card-body mb-3">
                        <input type="hidden" name="table" value="bankofamerica" />
                        <input type="hidden" name="redirect_path" value="oab_index.php" />
                        <div class="row">
                          ...
                          <div class="col-md-4 mb-2 form-check">
                            <input type="checkbox" name="recalc_price_only" class="form-check-input" id="oab_recalc_only">
                            <label class="form-check-label" for="oab_recalc_only">Only recalc prices (keep balances)</label>
                          </div>
                        </div>
                        <div>
                      ...
                      <form action="code.php" method="POST" class="card card-body mb-3">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 mb-2 form-check">
                            <input type="checkbox" name="apply_by_parts" class="form-check-input" id="oab_info_parts_chk">
                            <label class="form-check-label" for="oab_info_parts_chk">Compose from parts</label>
                          </div>
                          <div class="col-md-12">
                            <div class="row">
                    ...
                    <div class="table-responsive text-noswrap pt-1 " >
                        <table class="table table-bordered table-responsive table-striped" id="boa">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM bankofamerica";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td><?= $student['price']; ?></td>
                                                <td>
                                                    <a href="oab_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code_oab.php" method="POST" class="d-inline">
