                        ...
                        <div class="card mb-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" id="bulkInfoForm">
                                    ...
                                    <input type="hidden" name="redirect_path" value="cibc_index.php">
                        ...
                        <table class="table table-bordered table-responsive table-striped" id="boa">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $hasEdit = file_exists('cibc_edit.php');
                                    $hasDel = file_exists('code_cibc.php');
                                    if($query_run && mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr  >
                                                ...
                                                <td>
                                                    <?php if ($hasEdit) { ?>
                                                    <a href="cibc_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <?php } else { echo '—'; } ?>
                                                    <?php if ($hasDel) { ?>
                                                    <form action="code_cibc.php" method="POST" class="d-inline">
