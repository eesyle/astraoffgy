    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                  <div class="card-header"><strong>Bulk Balance & Price (Wellsfargo)</strong></div>
                  <div class="card-body">
                    <form action="code.php" method="POST">
                      <input type="hidden" name="table" value="wellsfargo" />
                      <input type="hidden" name="redirect_path" value="gw_edit.php" />
                      <div class="row">
                        ...
                        <div class="col-md-4 mb-2 form-check">
                          <input type="checkbox" name="recalc_price_only" class="form-check-input" id="gw_edit_recalc_only">
                          <label class="form-check-label" for="gw_edit_recalc_only">Only recalc prices (keep balances)</label>
                        </div>
                      </div>
                ...
                <div class="card mt-3">
                  <div class="card-header"><strong>Bulk Info (Wellsfargo)</strong></div>
                  <div class="card-body">
                    <form action="code.php" method="POST">
                      <input type="hidden" name="table" value="wellsfargo" />
                      <input type="hidden" name="redirect_path" value="gw_edit.php" />
                      <div class="row">
                        ...
                        <div class="col-md-3 mb-2 form-check">
                          <input type="checkbox" name="apply_by_parts" class="form-check-input" id="gw_edit_info_parts_chk">
                          <label class="form-check-label" for="gw_edit_info_parts_chk">Compose from parts</label>
                        </div>
                        <div class="col-md-12">
                          <div class="row">
